...
mydb = mysql.connector.connect(host="localhost", user="root", passwd="reyaz2727", database="flight")
mycursor = mydb.cursor()
price_data = mysql.connector.connect(host="localhost", user="root", passwd="reyaz2727", database="flight")
